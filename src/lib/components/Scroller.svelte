...
<script>
  ...
  $: style = `
    ...
    ${bp === "lg" || bp === "xl" ? "right: 0;" : ""}
		z-index: 1;
	`
  // z-index: background is infront except for the 4th section on mobile (Table)

  $: widthStyle = fixed ? (bp === "lg" || bp === "xl" ? " width: 50%" : `width:${width}px;`) : ""
